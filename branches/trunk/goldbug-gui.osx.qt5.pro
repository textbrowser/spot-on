...
sounds.path             = /Applications/GoldBug_Qt5.d/GoldBug.app/Contents/MacOS/Sounds
sounds.files            = Sounds/*.wav
spoton.path		= /Applications/GoldBug_Qt5.d/GoldBug.app
