...
other_libraries2.extra      = install_name_tool -change /usr/local/Cellar/openldap/2.6.0/lib/liblber.2.dylib @executable_path/../Frameworks/liblber.2.dylib /Applications/Spot-On.d/Spot-On.app/Contents/Frameworks/libldap.2.dylib
