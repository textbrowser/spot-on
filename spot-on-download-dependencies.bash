...
openssl=mingw-w64-i686-openssl-1.1.1.k-1-any.pkg.tar.zst
...
wget --output-document=$postgresql \
     --progress=bar \
     "https://get.enterprisedb.com/postgresql/postgresql-9.6.22-1-windows-binaries.zip"
