...
cp -p ./Shell/spot-on-kernel-power-saver.sh ./opt/spot-on/.
...
# Preparing Spot-On-2025.12.25_powerpc.deb:
...
fakeroot dpkg-deb --build spot-on-debian Spot-On-2025.12.25_powerpc.deb
make distclean
rm -fr ./opt
